<h2 class="woocommerce-order-details__title"><?php echo ($title = get_option('wooccm_order_custom_fields_title', false)) ? esc_html($title) : esc_html__('Datos adicionales del Pedido', 'woocommerce-checkout-manager'); ?></h2>
