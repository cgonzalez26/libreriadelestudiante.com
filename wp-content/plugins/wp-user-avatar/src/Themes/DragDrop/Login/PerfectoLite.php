...
class PerfectoLite extends AbstractTheme
{
    ...
    public function default_metabox_settings()
    {
        ...
        $data['perfectolite_login_bg_color']          = '#9ec23e';/*'#ffffff'; cristian*/        
...
HTML;
    ...
    public function form_css()
    {
        ...
        $button_bg_color   = '#9ec23e';/*$this->get_meta('perfectolite_login_button_bg_color');cristian*/
...
div#pp-$form_type-$form_id.perfecto input.ppform-submit-button {
    ...
    cursor: pointer;
    /*background: $button_bg_color; cristian*/
    background: #9ec23e;
    font-size: 11px;
    line-height: 21px;
    letter-spacing: 1px;
